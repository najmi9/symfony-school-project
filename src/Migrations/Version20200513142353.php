 ...
 */
final class Version20200513142353 extends AbstractMigration
{
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE prof_classe (prof_id INT NOT NULL, classe_id INT NOT NULL, INDEX IDX_199FD698ABC1F7FE (prof_id), INDEX IDX_199FD6988F5EA509 (classe_id), PRIMARY KEY(prof_id, classe_id)) DEFAULT CHARACTER SET utf8 COLLATE `utf8_unicode_ci` ENGINE = InnoDB COMMENT = \'\' ');
